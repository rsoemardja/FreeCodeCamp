...
def search_customer():
		...
		def edit_now(id, index):
			...
			name2 = (id, )
			results2 = my_cursor.execute(sql2, name2)
			...
			first_name_box2 = Entry(edit_customers)
			first_name_box2.insert(0, results[0][0])
			first_name_box2.grid(row=index+1, column=1)

			global last_name_box2
			last_name_box2 = Entry(edit_customers)
			last_name_box2.grid(row=index+2, column=1, pady=5)
			last_name_box2.insert(0, results[0][1])

			global address1_box2
			address1_box2 = Entry(edit_customers)
			address1_box2.grid(row=index+3, column=1, pady=5)
			address1_box2.insert(0, results[0][6])

			global address2_box2
			address2_box2 = Entry(edit_customers)
			address2_box2.grid(row=index+4, column=1, pady=5)
			address2_box2.insert(0, results[0][7])

			global city_box2
			city_box2 = Entry(edit_customers)
			city_box2.grid(row=index+5, column=1, pady=5)
			city_box2.insert(0, results[0][8])

			global state_box2
			state_box2 = Entry(edit_customers)
			state_box2.grid(row=index+6, column=1, pady=5)
			state_box2.insert(0, results[0][9])

			global zipcode_box2
			zipcode_box2 = Entry(edit_customers)
			zipcode_box2.grid(row=index+7, column=1, pady=5)
			zipcode_box2.insert(0, results[0][2])

			global country_box2
			country_box2 = Entry(edit_customers)
			country_box2.grid(row=index+8, column=1, pady=5)
			country_box2.insert(0, results[0][10])

			global phone_box2
			phone_box2 = Entry(edit_customers)
			phone_box2.grid(row=index+9, column=1, pady=5)
			phone_box2.insert(0, results[0][11])

			global email_box2
			email_box2 = Entry(edit_customers)
			email_box2.grid(row=index+10, column=1, pady=5)
			email_box2.insert(0, results[0][5])

			global payment_method_box2
			payment_method_box2 = Entry(edit_customers)
			payment_method_box2.grid(row=index+11, column=1, pady=5)
			payment_method_box2.insert(0, results[0][12])

			global discount_code_box2
			discount_code_box2 = Entry(edit_customers)
			discount_code_box2.grid(row=index+12, column=1, pady=5)
			discount_code_box2.insert(0, results[0][13])

			global price_paid_box2
			price_paid_box2 = Entry(edit_customers)
			price_paid_box2.grid(row=index+13, column=1, pady=5)
			price_paid_box2.insert(0, results[0][3])

			global id_box2
			id_box2 = Entry(edit_customers)
			id_box2.grid(row=index+14, column=1, pady=5)
			id_box2.insert(0, results[0][4])

			save_record = Button(edit_customers, text="Update Record", command=update)
...
search_customers_button.grid(row=15, column=0, sticky=W, padx=10)
